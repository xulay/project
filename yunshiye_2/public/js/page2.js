  ...
  $.fn.extend({
    ...
    page: function (options) {
      ...
      return this.each(function () {
        ...
        obj.html('<div class="last" style="float:right">' + opts.lastPage + '</div><div class="next" style="float:right">' + opts.next + '</div><ul class="pagingUl">' + str1 + str + '</ul><div class="prv" style="float:right">' + opts.prv + '</div><div class="first" style="float:right">' + opts.firstPage + '</div><span  class="Onow" style="float:right">'+pageshow+'/'+defaults.leng+'</span>                ');
        ...
        obj.on('click', '.next', function () {
          ...
          $('.Onow').html(pageshow+1+'/'+defaults.leng);
        });
        ...
        obj.on('click', 'li', function(){
          ...
          opts.clickBack(pageshow)
          $('.Onow').html(pageshow+'/'+defaults.leng);
        })
