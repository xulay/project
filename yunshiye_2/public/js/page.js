  ...
  $.fn.extend({
    ...
    page: function (options) {
      ...
      return this.each(function () {
        ...
        obj.html('<div class="last" style="float:right">' + opts.lastPage + '</div><div class="next" style="float:right">' + opts.next + '</div><ul class="pagingUl">' + str1 + str + '</ul><div class="prv" style="float:right">' + opts.prv + '</div><div class="first" style="float:right">' + opts.firstPage + '</div><span  class="Onow" style="float:right"><span class="Onow-num">'+pageshow+'</span>/'+defaults.leng+'</span>                ');
        ...
        obj.on('click', '.next', function () {
          ...
          var b=parseInt(pageshow+1);
          $('.Onow').html('<span class="Onow-num">'+b+'</span>/'+defaults.leng);
        });
        obj.on('click', '.prv', function () {
          ...
          opts.clickBack(pageshow-1)
          var a=parseInt(pageshow-1)
          $('.Onow').html('<span class="Onow-num">'+a+'</span>/'+defaults.leng);
        });
        ...
        obj.on('click', '.first', function(){
          ...
          $('.Onow').html('<span class="Onow-num">'+1+'</span>/'+defaults.leng);
        })
        ...
        obj.on('click', 'li', function(){
          ...
          opts.clickBack(pageshow)
          $('.Onow').html('<span class="Onow-num">'+pageshow+'</span>/'+defaults.leng);
        })
        ...
        function fpagePrv(prv){
          ...
          $('.Onow').html('<span class="Onow-num">'+1+'</span>/'+defaults.leng+'/'+defaults.leng);
        }
        ...
        function fpageNext(next){
          ...
          $('.Onow').html(defaults.leng+'/'+defaults.leng);
        }
      });
    },
